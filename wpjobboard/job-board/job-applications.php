            ...
            <div class="wpjb-col-5 wpjb-grid-col-right">
                <div class="wpjb-dropdown-wrap">
                    ...
                    <ul id="wpjb-dropdown-<?php echo $application->id ?>" class="wpjb-dropdown">
                        ...
                        <li><a href="<?php echo wpjb_api_url("action/application", array("id"=>$application->id, "status"=>$k, "redirect_to"=>wpjb_link_to("job_applications", $job))) ?>"><?php esc_html_e($v) ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            </div>
