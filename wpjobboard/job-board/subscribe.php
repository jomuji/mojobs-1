...
<div id="wpjb-overlay" class="wpjb wpjb-overlay wpjb-subscribe-rss">
     <div>
         <h2>
             ...
             <a href="#" class="wpjb-subscribe-close wpjb-glyphs wpjb-icon-cancel" title="<?php _e("Close", "wpjobboard") ?>"></a>
         </h2>
         ...
         <div>
             ...
             <form action="" method="post">
                 <p>
                     ...
                     <input type="text" placeholder="<?php _e("enter your email address here ...", "wpjobboard") ?>" id="wpjb-subscribe-email" value="" name="email" style="width:60%" />
