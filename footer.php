        ...
        <footer class="footer">
            <div class="container">
                <div class="row footer-widgets">
                    ...
                    <div class="col-md-3 col-xs-12">
                        <div class="footer-widget mail-subscribe-widget">
                            <h4>Restons en contact<span class="head-line"></span></h4>
                    ...
                    <div class="col-md-3 col-xs-12">
                        <div class="footer-widget twitter-widget">
                            <h4>Twitter<span class="head-line"></span></h4>
                            <ul>
                                <li>
                    ...
                    <div class="col-md-3 col-xs-12">
                        <div class="footer-widget contact-widget">
                            <h4>Secretaire-inc</h4>
                            <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident</p>
                            <ul>
                                <li><span>Téléphone:</span> 514-271-4884</li>
                                <li><span>Courriel:</span> info@secretaire-inc.com</li>
                                <li><span>Site web:</span> www.secretaire-inc.com</li>
                            </ul>
                        </div>
                    </div><!-- .col-md-3 -->
                    <!-- End Contact Widget -->
                ...
                <div class="copyright-section">
                    <div class="row">
                        <div class="col-md-6">
                            <p>&copy; 2014 Secretaire-inc.com -  Tous droits réservés,  par<a href="http://www.netavantage.com">  Net Avantage Solutions</a> </p>
                        </div><!-- .col-md-6 -->
                        <div class="col-md-6">
                            <ul class="footer-nav">
                                <li><a href="#">Sitemap</a>
